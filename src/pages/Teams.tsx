              ...
              <div className="p-2 md:p-3">
                <div className="flex items-start justify-between gap-2 mb-2">
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    <button
                      onClick={() => openCommentsModal(team.name)}
                ...
                <div className="space-y-0.5">
                  {team.members
                    ...
                    .map((member, index) => (
                      <div
                        key={member.id}
                        className="flex items-center justify-between text-xs py-0.5 px-1.5 rounded hover:bg-white/5"
                      >
                        ...
                        <span className="text-accent font-semibold flex-shrink-0 ml-2">
                  ...
                  {(() => {
                    ...
                    return mostImproved && mostImproved.rankChange?.direction === 'up' ? (
                      <div className="bg-green-500/10 rounded p-2">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-white font-semibold">{mostImproved.name}</span>
                          <span className="text-xs text-green-400">
                            ↑{mostImproved.rankChange.change} spots
                          </span>
                        </div>
                      </div>
                    ) : null;
